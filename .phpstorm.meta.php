    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'laratex' => \Ismaelw\LaraTeX\LaraTeX::class,
    ...
    override(\config(), map([
            ...
            'broadcasting.connections.pusher.config.cluster' => 'NULL',
            'broadcasting.connections.pusher.config.useTLS' => 'boolean',
            ...
            'cache.stores.memcached.config' => 'array',
            ...
            'database.connections.mysql.config' => 'array',
            ...
            'database.redis.config.cluster' => 'string',
            'database.redis.config.prefix' => 'string',
            ...
            'filesystems.disks.tools.driver' => 'string',
            'filesystems.disks.tools.root' => 'string',
            'filesystems.disks.devs.driver' => 'string',
            'filesystems.disks.devs.root' => 'string',
            'filesystems.disks.challenges.driver' => 'string',
            'filesystems.disks.challenges.root' => 'string',
            'filesystems.disks.chapters.driver' => 'string',
            'filesystems.disks.chapters.root' => 'string',
            'filesystems.disks.illustrations.driver' => 'string',
            'filesystems.disks.illustrations.root' => 'string',
            'filesystems.disks.widgets.driver' => 'string',
            'filesystems.disks.widgets.root' => 'string',
            'filesystems.links.C:\websites\scolcours_gymnase\public\storage' => 'string',
            ...
            'laratex.binPath' => 'string',
            'laratex.bibTexPath' => 'string',
            'laratex.tempPath' => 'string',
            'laratex.teardown' => 'boolean',
            ...
            'telescope-toolbar.enabled' => 'boolean',
            'telescope-toolbar.replace' => 'boolean',
            'telescope-toolbar.light_theme' => 'boolean',
            'telescope-toolbar.new_tab' => 'boolean',
            'telescope-toolbar.path' => 'string',
            'telescope-toolbar.middleware' => 'array',
            'telescope-toolbar.asset_middleware' => 'array',
            'telescope-toolbar.excluded_ajax_paths' => 'string',
            'telescope-toolbar.ignore_paths' => 'array',
            'telescope-toolbar.store_redirects' => 'boolean',
            'telescope-toolbar.dump_watcher' => 'boolean',
            'telescope-toolbar.collectors.request' => 'array',
            'telescope-toolbar.collectors.exception' => 'array',
            'telescope-toolbar.collectors.view' => 'array',
            'telescope-toolbar.collectors.query' => 'array',
            'telescope-toolbar.collectors.cache' => 'array',
            'telescope-toolbar.collectors.log' => 'array',
            'telescope-toolbar.collectors.mail' => 'array',
            'telescope-toolbar.collectors.notification' => 'array',
            'telescope-toolbar.collectors.gate' => 'array',
            'telescope-toolbar.collectors.job' => 'array',
            'telescope-toolbar.collectors.command' => 'array',
            'telescope-toolbar.collectors.dump' => 'array',
            'telescope-toolbar.collectors.event' => 'array',
            'telescope-toolbar.collectors.model' => 'array',
            'telescope-toolbar.collectors.redis' => 'array',
            'telescope-toolbar.collectors.schedule' => 'array',
...
'broadcasting.connections.pusher.config.cluster','broadcasting.connections.pusher.config.useTLS','broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver',
...
'cache.stores.memcached.config','cache.stores.memcached.servers.0.host','cache.stores.memcached.servers.0.port','cache.stores.memcached.servers.0.weight','cache.stores.redis.driver',
...
'database.connections.mysql.prefix','database.connections.mysql.prefix_indexes','database.connections.mysql.strict','database.connections.mysql.engine','database.connections.mysql.config',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.migrations','database.redis.client','database.redis.config.cluster',
'database.redis.config.prefix','database.redis.default.url','database.redis.default.host','database.redis.default.password','database.redis.default.port',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.tools.driver','filesystems.disks.tools.root','filesystems.disks.devs.driver','filesystems.disks.devs.root',
'filesystems.disks.challenges.driver','filesystems.disks.challenges.root','filesystems.disks.chapters.driver','filesystems.disks.chapters.root','filesystems.disks.illustrations.driver',
'filesystems.disks.illustrations.root','filesystems.disks.widgets.driver','filesystems.disks.widgets.root','filesystems.links.C:\\websites\\scolcours_gymnase\\public\\storage','hashing.driver',
...
'laratex.binPath','laratex.bibTexPath','laratex.tempPath','laratex.teardown','logging.default',
...
'view.paths','view.compiled','concurrency.default','telescope-toolbar.enabled','telescope-toolbar.replace',
'telescope-toolbar.light_theme','telescope-toolbar.new_tab','telescope-toolbar.path','telescope-toolbar.middleware','telescope-toolbar.asset_middleware',
'telescope-toolbar.excluded_ajax_paths','telescope-toolbar.ignore_paths','telescope-toolbar.store_redirects','telescope-toolbar.dump_watcher','telescope-toolbar.collectors.request',
'telescope-toolbar.collectors.exception','telescope-toolbar.collectors.view','telescope-toolbar.collectors.query','telescope-toolbar.collectors.cache','telescope-toolbar.collectors.log',
'telescope-toolbar.collectors.mail','telescope-toolbar.collectors.notification','telescope-toolbar.collectors.gate','telescope-toolbar.collectors.job','telescope-toolbar.collectors.command',
'telescope-toolbar.collectors.dump','telescope-toolbar.collectors.event','telescope-toolbar.collectors.model','telescope-toolbar.collectors.redis','telescope-toolbar.collectors.schedule',
...
'admin.config.updateOrder','admin.chapters','admin.tools','admin.challenges','admin.generators',
'admin.widgets','admin.widgets.refresh','widgets.update','widgets.components','admin.users',
'admin.users.create','admin.users.update','admin.users.destroy','toggleChapterActive','users.team.toggle',
'teams.store','teams.destroy','admin.illustrations.index','api.update.a.value','register','login','password.request','password.email',
'password.reset','password.update','verification.notice','verification.verify','verification.send',
'password.confirm','logout','translations.index','translations.show',
'translation.books','translations.units','translations.words','translations.import','translation.books.create',
'translations.create','translations.words.update','questions.validate','questions.show','questions.edit',
'questions.duplicate','questions.update','questions.storeTo','questions.updateOrder','questions.answers.reset',
'questions.batch.updateDisplayIf','questions.updateDisplayIf','questions.moveTo.post','questions.destroy','blocks.show',
'blocks.edit','posts.blocks.store','blocks.update','blocks.updateTemplate','blocks.blur',
...
'generators.destroy','challenges.show','chapters.challenge','chapters.challenges.store','challenges.update',
'challenges.destroy','challenges.generators.index','challenges.generators.updateOrder','challenges.generators.store','challenges.generators.attach',
'challenges.generators.detach','challenges.edit','challenges.team','teams.index','teams.show',
'teams.challenge','teams.chapters.stats','decks.index','decks.show',
...
'dev.index','tools','tools.tool','tools.edit','tools.update','quizzs.index','quizzs.sessions.show','quizzs.admin','quizzs.admin.quizz',
'quizzs.sessions.dashboard','quizzs.sessions.projection','quizzs.store','quizzs.destroy','quizzs.sessions.create',
'quizzs.sessions.destroy','quizzs.sessions.updateCurrent','quizzs.sessions.updateEnable','quizzs.update','evaluations.show','latex.pdf','latex.links','latex.download','bareme.show','grapheur.show','grapheur.download',
'dico.exists','dico.fetch','theme','themes.chapters.intro','chapters.theorems.index',
'chapters.slide','chapters.show','themes.chapters.slide','themes.chapters.slide.anchor','chapters.edit',
'themes.chapters.store','chapters.update','chapters.destroy','chapters.currentPost','chapters.updatePostsOrder',
'chapters.index.min','chapters.relations.toggle','chapters.info',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','fr.0','validation-attributes.attributes.address',
'validation-attributes.attributes.age','validation-attributes.attributes.available','validation-attributes.attributes.city','validation-attributes.attributes.content','validation-attributes.attributes.country',
'validation-attributes.attributes.current_password','validation-attributes.attributes.date','validation-attributes.attributes.day','validation-attributes.attributes.description','validation-attributes.attributes.email',
'validation-attributes.attributes.excerpt','validation-attributes.attributes.first_name','validation-attributes.attributes.gender','validation-attributes.attributes.hour','validation-attributes.attributes.last_name',
'validation-attributes.attributes.minute','validation-attributes.attributes.mobile','validation-attributes.attributes.month','validation-attributes.attributes.name','validation-attributes.attributes.password',
'validation-attributes.attributes.password_confirmation','validation-attributes.attributes.phone','validation-attributes.attributes.second','validation-attributes.attributes.sex','validation-attributes.attributes.size',
'validation-attributes.attributes.time','validation-attributes.attributes.title','validation-attributes.attributes.username','validation-attributes.attributes.year','validation-inline.accepted',
...
'validation-inline.alpha_dash','validation-inline.alpha_num','validation-inline.array','validation-inline.attached','validation-inline.before',
...
'validation-inline.date_format','validation-inline.different','validation-inline.digits','validation-inline.digits_between','validation-inline.dimensions',
'validation-inline.distinct','validation-inline.email','validation-inline.ends_with','validation-inline.exists','validation-inline.file',
...
'validation-inline.max.array','validation-inline.max.file','validation-inline.max.numeric','validation-inline.max.string','validation-inline.mimes',
'validation-inline.mimetypes','validation-inline.min.array','validation-inline.min.file','validation-inline.min.numeric','validation-inline.min.string',
'validation-inline.multiple_of','validation-inline.not_in','validation-inline.not_regex','validation-inline.numeric','validation-inline.password',
'validation-inline.present','validation-inline.prohibited','validation-inline.prohibited_if','validation-inline.prohibited_unless','validation-inline.prohibits',
'validation-inline.regex','validation-inline.relatable','validation-inline.required','validation-inline.required_if','validation-inline.required_unless',
'validation-inline.required_with','validation-inline.required_with_all','validation-inline.required_without','validation-inline.required_without_all','validation-inline.same',
'validation-inline.size.array','validation-inline.size.file','validation-inline.size.numeric','validation-inline.size.string','validation-inline.starts_with',
'validation-inline.string','validation-inline.timezone','validation-inline.unique','validation-inline.uploaded','validation-inline.url',
'validation-inline.uuid','validation-inline.custom.attribute-name.rule-name','validation.attached','validation.relatable',);
