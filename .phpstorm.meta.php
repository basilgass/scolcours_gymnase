...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','view.paths','view.compiled','concurrency.default','telescope-toolbar.enabled',
'telescope-toolbar.replace','telescope-toolbar.light_theme','telescope-toolbar.new_tab','telescope-toolbar.path','telescope-toolbar.middleware',
'telescope-toolbar.asset_middleware','telescope-toolbar.excluded_ajax_paths','telescope-toolbar.ignore_paths','telescope-toolbar.store_redirects','telescope-toolbar.dump_watcher',
'telescope-toolbar.collectors.request','telescope-toolbar.collectors.exception','telescope-toolbar.collectors.view','telescope-toolbar.collectors.query','telescope-toolbar.collectors.cache',
'telescope-toolbar.collectors.log','telescope-toolbar.collectors.mail','telescope-toolbar.collectors.notification','telescope-toolbar.collectors.gate','telescope-toolbar.collectors.job',
'telescope-toolbar.collectors.command','telescope-toolbar.collectors.dump','telescope-toolbar.collectors.event','telescope-toolbar.collectors.model','telescope-toolbar.collectors.redis',
'telescope-toolbar.collectors.schedule','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'validation.numeric','validation.password','validation.present','validation.present_if','validation.present_unless',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','fr.0',
'validation-attributes.attributes.address','validation-attributes.attributes.age','validation-attributes.attributes.available','validation-attributes.attributes.city','validation-attributes.attributes.content',
'validation-attributes.attributes.country','validation-attributes.attributes.current_password','validation-attributes.attributes.date','validation-attributes.attributes.day','validation-attributes.attributes.description',
'validation-attributes.attributes.email','validation-attributes.attributes.excerpt','validation-attributes.attributes.first_name','validation-attributes.attributes.gender','validation-attributes.attributes.hour',
'validation-attributes.attributes.last_name','validation-attributes.attributes.minute','validation-attributes.attributes.mobile','validation-attributes.attributes.month','validation-attributes.attributes.name',
'validation-attributes.attributes.password','validation-attributes.attributes.password_confirmation','validation-attributes.attributes.phone','validation-attributes.attributes.second','validation-attributes.attributes.sex',
'validation-attributes.attributes.size','validation-attributes.attributes.time','validation-attributes.attributes.title','validation-attributes.attributes.username','validation-attributes.attributes.year',
...
'validation-inline.alpha','validation-inline.alpha_dash','validation-inline.alpha_num','validation-inline.array','validation-inline.attached',
'validation-inline.before','validation-inline.before_or_equal','validation-inline.between.array','validation-inline.between.file','validation-inline.between.numeric',
'validation-inline.between.string','validation-inline.boolean','validation-inline.confirmed','validation-inline.current_password','validation-inline.date',
'validation-inline.date_equals','validation-inline.date_format','validation-inline.different','validation-inline.digits','validation-inline.digits_between',
'validation-inline.dimensions','validation-inline.distinct','validation-inline.email','validation-inline.ends_with','validation-inline.exists',
...
'validation-inline.lte.string','validation-inline.max.array','validation-inline.max.file','validation-inline.max.numeric','validation-inline.max.string',
...
'validation-inline.prohibits','validation-inline.regex','validation-inline.relatable','validation-inline.required','validation-inline.required_if',
