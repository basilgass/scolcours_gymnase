...
| Lot 3 | Keyboards | 122 | ⬜ À faire (découpé 3.A→3.F) |
| Lot 4 | Widgets | ~80 | ⬜ À faire |
...
## Lot 4 — Widgets — ~80 err
`Widgets/algebre/matrice-augmentee.vue` (35), `arithmetique/algorithme-bezout.vue` (12), + reste.
