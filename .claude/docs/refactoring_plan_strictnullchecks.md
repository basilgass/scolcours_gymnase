...
`tests/ts/**` (10 err, `possibly undefined` sur helpers de test). **+1 dérive apparue au Lot 4.D**
(2026-07-28) : `tests/ts/Components/Keyboards/KeyboardDisplay.characterization.test.ts(56)` TS2322
`VueWrapper<...>` non assignable — artefact d'inférence générique vue-tsc (surgit quand l'ensemble
global d'erreurs baisse ; aucun lien fonctionnel), à traiter avec le reste des tests. Puis décommenter définitivement
