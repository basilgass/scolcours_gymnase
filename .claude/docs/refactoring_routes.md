...
| ✅ | `admin.courses.dashboard`          | `admin.courses.teams.dashboard`     | —          | `{course}` `{team:name}`                                      |
| ✅ | `admin.courses.lessons.show`       | `admin.courses.teams.lessons.show`  | —          | `{course}` `{team:name}` `{lesson}`                           |
| ✅ | `admin.courses.show-team`          | `admin.courses.teams.show`          | —          | `{course}` `{team:name}`                                      |
