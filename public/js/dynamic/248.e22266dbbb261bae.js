"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[248,280],{
...
// EXTERNAL MODULE: ./node_modules/vue/dist/vue.esm-bundler.js + 6 modules
var vue_esm_bundler = __webpack_require__(821);
// EXTERNAL MODULE: ./resources/js/Pages/Shared/LayoutFullpage.vue + 4 modules
var LayoutFullpage = __webpack_require__(280);
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Pages/Welcome.vue?vue&type=script&setup=true&lang=js


var _hoisted_1 = /*#__PURE__*/(0,vue_esm_bundler.createElementVNode)("div", {
  "class": "text-center py-10"
}, [/*#__PURE__*/(0,vue_esm_bundler.createElementVNode)("div", {
  "class": "text-4xl"
}, " Gymnase "), /*#__PURE__*/(0,vue_esm_bundler.createElementVNode)("div", {
  "class": "text-sm"
...
var _hoisted_3 = /*#__PURE__*/(0,vue_esm_bundler.createTextVNode)(" Vers les quizz / challenge ");
...
var __default__ = {
  layout: LayoutFullpage["default"]
};
/* harmony default export */ const Welcomevue_type_script_setup_true_lang_js = (/*#__PURE__*/Object.assign(__default__, {
  props: {
    canLogin: Boolean,
    canRegister: Boolean,
    themes: Array
  ...
  setup: function setup(__props) {
    return function (_ctx, _cache) {
      ...
      return (0,vue_esm_bundler.openBlock)(), (0,vue_esm_bundler.createElementBlock)(vue_esm_bundler.Fragment, null, [_hoisted_1, (0,vue_esm_bundler.createElementVNode)("div", _hoisted_2, [(0,vue_esm_bundler.createVNode)(_component_Link, {
        href: "/challenge"
      }, {
        "default": (0,vue_esm_bundler.withCtx)(function () {
          return [_hoisted_3];
        ...
        _: 1
      })]), (0,vue_esm_bundler.createElementVNode)("div", _hoisted_4, [(0,vue_esm_bundler.createElementVNode)("div", _hoisted_5, [((0,vue_esm_bundler.openBlock)(true), (0,vue_esm_bundler.createElementBlock)(vue_esm_bundler.Fragment, null, (0,vue_esm_bundler.renderList)(__props.themes, function (theme, index) {
        return (0,vue_esm_bundler.openBlock)(), (0,vue_esm_bundler.createBlock)(_component_Link, {
          key: theme.slug,
          "class": (0,vue_esm_bundler.normalizeClass)(['scolcours-' + theme.slug + ' ' + (index % 2 === 0 ? 'rotate-1' : '-rotate-1'), "text-center text-lg font-thin whitespace-nowrap rounded border py-24 text-white cursor-pointer transform hover:scale-105 hover:rotate-0 duration-300"]),
          href: '/' + theme.slug
        }, {
          "default": (0,vue_esm_bundler.withCtx)(function () {
            return [(0,vue_esm_bundler.createElementVNode)("i", {
              "class": (0,vue_esm_bundler.normalizeClass)("bi bi-".concat(theme.icon, " mr-2"))
            }, null, 2), (0,vue_esm_bundler.createTextVNode)(" " + (0,vue_esm_bundler.toDisplayString)(theme.title), 1)];
          }),
          _: 2
        }, 1032, ["class", "href"]);
...
;// CONCATENATED MODULE: ./resources/js/Pages/Welcome.vue?vue&type=script&setup=true&lang=js
 
;// CONCATENATED MODULE: ./resources/js/Pages/Welcome.vue



const __exports__ = Welcomevue_type_script_setup_true_lang_js;

/* harmony default export */ const Welcome = (__exports__);
