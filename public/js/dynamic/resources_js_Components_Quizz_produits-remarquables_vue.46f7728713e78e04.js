...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    function newQuestion() {
      var P = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_2__.Random.polynom({
        letters: "x",
        degree: 1,
        unit: true,
      ...
      if (pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_2__.Random.bool(0.33)) {
        return P.clone().multiply(P.monomsByDegree(0).opposed);
      } else {
        return P.pow(2);
      }
    }
