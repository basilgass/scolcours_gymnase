...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup(__props, _ref) {
    ...
    function newQuestion() {
      var P = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.polynom({
        letters: 'x',
        degree: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.number(2, 5),
        numberOfMonoms: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.number(2, 3),
        fraction: false
      }).reorder(),
          degree = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.number(2, 5),
          factor = points.value < 3 ? 1 : pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(10, false),
      ...
      if (pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.bool()) {
        // Two factors
        // Constant
        k = new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_2__.Fraction(factor, degree + 1).reduce(); // Result as ascii math
        ...
        // Rational
        // Constant
        k = new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_2__.Fraction(factor, -degree + 1).reduce(); // Get the denominator
