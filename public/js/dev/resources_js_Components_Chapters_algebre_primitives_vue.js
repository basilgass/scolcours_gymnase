...
/* harmony import */ var pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! pimath/esm/maths/coefficients */ "./node_modules/pimath/esm/maths/coefficients/index.js");
/* harmony import */ var pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! pimath/esm/maths/random */ "./node_modules/pimath/esm/maths/random/index.js");
/* harmony import */ var pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup(__props, _ref) {
    ...
    function formatQuestion(A, pow, k) {
      ...
      if (pow instanceof pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction) {
        var numerator = pow.numerator,
            denominator = pow.denominator,
            _D = A.clone().multiply(k).derivative(),
            primitivePow = pow.clone().add(1);

        F = new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(k).divide(primitivePow);
        ...
        B = new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom("x^(".concat(pow, ")"));
        ...
        F = new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(k).divide(pow + 1);
    ...
    function generatePower(model) {
      ...
      if (model === 'factors') {
        pow = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 6);
        ...
        pow = new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.fraction({
          max: 3,
          zero: false,
          natural: false,
          negative: false
        ...
        if (pow.isOne()) {
          pow = new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('1/2');
    ...
    function generateQuestions(randomize) {
      ...
      if (randomize) {
        ...
        items.push({
          A: new pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.polynom({
            degree: 0,
            fraction: {
              natural: true,
              max: maxValue
        ...
        items.push({
          A: new pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.polynom({
            degree: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 9),
            allowNullMonom: false,
            numberOfMonoms: 1,
            fraction: {
              natural: true,
        ...
        D = new pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.polynom({
          degree: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 9),
          allowNullMonom: false,
          numberOfMonoms: 1,
          fraction: {
        ...
        items.push({
          A: new pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.polynom({
            degree: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 5),
            allowNullMonom: false,
            numberOfMonoms: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 3),
            fraction: {
              natural: true,
              max: maxValue
            }
        ...
        for (var _i = 0, _models = models; _i < _models.length; _i++) {
          ...
          items.push({
            ...
            k: new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(1)
          ...
          items.push({
            ...
            pow: generatePower(model),
            k: new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 5))
          }); // With a fraction factor - must create the polynom.

          n = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 5);
          D = new pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.polynom({
            degree: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(1, 4),
            numberOfMonoms: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random.number(2, 3),
            fraction: {
              natural: true,
              max: maxValue
          ...
          items.push({
            A: D,
            pow: generatePower(model),
            k: new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(1).divide(n)
          });
        }
        ...
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('7')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('3x')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('5x^3')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('2/5x^2')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('4x^2+3x+5')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^2+3x'), 3, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(1)));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('2x^3+5x'), 5, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(2)));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^2+4x'), 3, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('1/2')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('3x^2+7x+9'), -3, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('1')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^3+9'), -4, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(6)));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('3x^4+2x^2+1'), -2, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('1/4')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('3x^4+2x^2+1'), -1, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(1)));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^3+2x^2'), -1, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('6')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('2x^3+x^2'), -1, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('1/2')));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^2-5'), 0, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(1)));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^3+4x'), 0, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction(2)));
        questions.push(formatQuestion(new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_3__.Polynom('x^5+5x^3'), 0, new pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction('1/5')));
      }
    ...
    var __returned__ = {
      ...
      Fraction: pimath_esm_maths_coefficients__WEBPACK_IMPORTED_MODULE_4__.Fraction,
      Random: pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_5__.Random
    };
...
/* harmony import */ var pimath_esm_maths_random_random__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! pimath/esm/maths/random/random */ "./node_modules/pimath/esm/maths/random/random.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup(__props, _ref) {
    ...
    function newQuestion() {
      var M = pimath_esm_maths_random_random__WEBPACK_IMPORTED_MODULE_3__.Random.monom({
        letter: 'x',
        degree: pimath_esm_maths_random_random__WEBPACK_IMPORTED_MODULE_3__.Random.number(1, 8),
        fraction: true
      });
      state.userAnswer = '';
    ...
    var __returned__ = {
      ...
      Random: pimath_esm_maths_random_random__WEBPACK_IMPORTED_MODULE_3__.Random
    };
    Object.defineProperty(__returned__, '__isScriptSetup', {
      enumerable: false,
      value: true
