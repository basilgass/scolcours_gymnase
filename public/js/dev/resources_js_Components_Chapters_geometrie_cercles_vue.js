...
/* harmony import */ var pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! pimath/esm/maths/geometry */ "./node_modules/pimath/esm/maths/geometry/index.js");
/* harmony import */ var pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup(__props, _ref) {
    ...
    var root = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(null),
      ...
      C1: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(-5, 4),
      r1: 36,
      G1: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Circle(),
      C2: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(7, -2),
      T: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(2, 3),
      G2: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Circle(),
      t: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(),
      d: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(),
      m: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(),
      M: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(0, 0),
      P1: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(),
      P2: new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point()
    }),
    ...
    function updateEx1Rnd() {
      ...
      var nb = 20;
      position = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.number(0, 2);

      if (position === 2) {
        P1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true));
        P2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true)); // On s'assure que les deux points ne sont pas de même coordonnées
        // On impose (artificiellement), que la coordonnées x doit être différente

        while (P2.x.isEqual(P1.x)) {
          P2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true));
        } // On calcule ce qui sera la tangente.


        t = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(P1, P2).simplify(); // On prend un point aléatoire sur cette tangente.

        Tx = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
        T = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(Tx, t.getValueAtX(Tx)); // Le point T ne doit pas être une des coordonnées P1, P2 (impossible), ni entre P1 et P2

        while (T.x.value >= Math.min(P1.x.value, P2.x.value) && T.x.value <= Math.max(P1.x.value, P2.x.value)) {
          Tx = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
          T = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(Tx, t.getValueAtX(Tx));
        } // On recheche la droite


        M = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point().middleOf(P1, P2);
        perp1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line().parseByPointAndNormal(M, t.director);
        C1x = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
        C1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(C1x, perp1.getValueAtX(C1x));
        r1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Vector(C1, P1).normSquare;
        perp2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line().parseByPointAndNormal(T, t.director);
        C2x = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
        C2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(C2x, perp2.getValueAtX(C1x));
        r2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Vector(C2, T).normSquare;
      } else if (position === 1) {
        P1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true));
        P2 = false;
        T = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true)); // La point T et P1 ne doivent pas être identique.

        while (T.x.isEqual(P1.x) && T.y.isEqual(P1.y)) {
          T = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true));
        } // On calcule ce qui sera la tangente.


        t = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(P1, T).simplify(); // On recheche la droite

        perp1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line().parseByPointAndNormal(P1, t.director);
        C1x = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
        C1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(C1x, perp1.getValueAtX(C1x));
        r1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Vector(C1, P1).normSquare;
        perp2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line().parseByPointAndNormal(T, t.director);
        ...
        P2 = false;
        T = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true));
        C2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true)); // Le point de tangence ne peut pas être sur le centre

        while (T.x.isEqual(C2.x)) {
          T = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true), pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true));
        }

        var vecteurRadius = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Vector(T, C2),
            rayon = vecteurRadius.norm;
        t = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(T, vecteurRadius, pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line.PERPENDICULAR); // On recheche la droite

        var Kx = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true),
            K = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(Kx, t.getValueAtX(Kx)); // Le point de tangence ne peut pas être sur le centre

        while (K.x.isEqual(T.x)) {
          Kx = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
          K = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(Kx, t.getValueAtX(Kx));
        }

        perp1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line().parseByPointAndNormal(K, t.director);
        C1x = pimath_esm_maths_random__WEBPACK_IMPORTED_MODULE_3__.Random.numberSym(nb, true);
        C1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point(C1x, perp1.getValueAtX(C1x));
      ...
      if (C1.x.isNatural() && C1.y.isNatural() && C2.x.isNatural() && C2.y.isNatural() && T.x.isNatural() && T.y.isNatural() || count.value > 20) {
        ex1.value.C1 = C1;
        ex1.value.r1 = r1;
        ex1.value.G1 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Circle(C1, r1, true);
        ex1.value.C2 = C2;
        ex1.value.T = T;
        ex1.value.G2 = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Circle(C2, r2, true);
        ex1.value.t = t;
        ex1.value.d = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line(C1, C2);
        ex1.value.m = new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line().parseByPointAndNormal(new pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point().middleOf(C1, C2), ex1.value.d.director);
        ex1.value.P1 = P1;
        ex1.value.P2 = P2;
      } else {
        count.value++;
    ...
    var __returned__ = {
      ...
      Circle: pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Circle,
      Line: pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Line,
      Point: pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Point,
      Vector: pimath_esm_maths_geometry__WEBPACK_IMPORTED_MODULE_2__.Vector,
...
var _hoisted_6 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ol", {
  "class": "list-decimal list-inside mt-5 space-y-3"
...
var _hoisted_7 = {
  "class": "list-decimal list-inside mt-5 space-y-3 text-gray-100 hover:text-gray-600 transition-colors"
};
