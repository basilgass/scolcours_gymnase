...
/* harmony import */ var pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! pimath/esm/maths/algebra */ "./node_modules/pimath/esm/maths/algebra/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup(__props, _ref) {
    ...
    var quadratique = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(function () {
      var P = new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Equation("y = a*x^2+b*x+c"),
      ...
      var Pc = P.clone().replaceBy("x", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pA.x.display)).replaceBy("y", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pA.y.display)).isolate("c"),
          Pb = P.clone().replaceBy("x", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pB.x.display)).replaceBy("y", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pB.y.display)).replaceBy("c", Pc.right).isolate("b"),
          Pa;

      if (C.value !== "") {
        Pa = P.clone().replaceBy("x", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pC.x.display)).replaceBy("y", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pC.y.display)).replaceBy("c", Pc.right).replaceBy("b", Pb.right).isolate("a");
      } else {
        // Le point B est un sommet !
        // x = -b/2a => b = -2ax
        Pa = new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Equation("b = -2a*x").replaceBy("x", new pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom(pC.x.display));
    ...
    var __returned__ = {
      ...
      Equation: pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Equation,
      Polynom: pimath_esm_maths_algebra__WEBPACK_IMPORTED_MODULE_4__.Polynom
    };
