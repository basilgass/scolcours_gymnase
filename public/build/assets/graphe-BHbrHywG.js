import{A as e,O as t,St as n,T as r,U as i,ht as a,rt as o,x as s}from"./@inertiajs-C0oRnCTy.js";import{t as c}from"./PiDrawParser-B4gCNu18.js";import{t as l}from"./Card-y55CIRLv.js";import{t as u}from"./useToolsStorage-Ce2Gb7iv.js";import{t as d}from"./ToolForm-Diq2y2Kk.js";var f={class:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3`},p=e({__name:`graphe`,setup(e){let{restoreTool:p}=u(),m=p([{label:`paramètres`,type:`text`,value:a(`axis,grid,x=-10:10,y=-10:10`),fromUrl:`params`},{label:`code`,type:`codearea`,value:a(`O(0,0)
A(5,1)
B(3,8)->drag=grid
d=OA.
e=OB.
