import{Ct as e,D as t,U as n,b as r,ht as i,k as a,rt as o,w as s}from"./@inertiajs-DtbEXzlC.js";import{t as c}from"./PiDrawParser-BkYykrQA.js";import{t as l}from"./Card-Dmucm9E5.js";import{t as u}from"./useToolsStorage-BQDQYkRM.js";import{t as d}from"./ToolForm-DzqyxM6a.js";var f={class:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3`},p=a({__name:`graphe`,setup(a){let{restoreTool:p}=u(),m=p([{label:`paramètres`,type:`codearea`,attributes:{language:`pidraw-params`,rows:1},value:i(`axis,grid,x=-10:10,y=-10:10`),fromUrl:`params`},{label:`code`,type:`codearea`,attributes:{language:`pidraw`,rows:10},value:i(`O(0,0)
A(5,1)
B(3,8)->drag=grid
d=OA.
e=OB.
