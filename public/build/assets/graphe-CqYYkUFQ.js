import{D as e,H as t,b as n,k as r,mt as i,nt as a,w as o,xt as s}from"./@inertiajs-CYi4IIr1.js";import{t as c}from"./PiDrawParser-Ch53ykeB.js";import{t as l}from"./Card-DGVG0mn1.js";import{t as u}from"./useToolsStorage-YOEYn230.js";import{t as d}from"./ToolForm-C23eWMyx.js";var f={class:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3`},p=r({__name:`graphe`,setup(r){let{restoreTool:p}=u(),m=p([{label:`paramètres`,type:`codearea`,attributes:{language:`pidraw-params`,rows:1},value:i(`axis,grid,x=-10:10,y=-10:10`),fromUrl:`params`},{label:`code`,type:`codearea`,attributes:{language:`pidraw`,rows:10},value:i(`O(0,0)
A(5,1)
B(3,8)->drag=grid
d=OA.
e=OB.
