...
0 & 0 & 1 & \\ldots \\\\
\\end{array}\\right)\\]
`,U={key:0,class:"my-10"},V={key:1,class:"text-red-700 text-sm"},Rt=b({__name:"matrice-augmentee",setup(E){const{restoreTool:v}=q(),r=v([{label:"matrice",type:"textarea",value:l(`2 1 -1
1 2 1
