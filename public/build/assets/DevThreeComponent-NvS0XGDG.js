import{D as e,H as t,k as n,mt as r,w as i,x as a}from"./@inertiajs-DcPzCMHT.js";import{t as o}from"./FormInput-BuloSurU.js";import{t as s}from"./FormCodearea-eDZ46zpV.js";import{t as c}from"./PiThreeParser-BLN-0CK2.js";var l={ref:`root`},u={class:`grid grid-cols-1 md:grid-cols-2 gap-3`},d={class:`flex flex-col gap-2`},f=n({__name:`DevThreeComponent`,setup(n){let f=r(`grid,axis`),p=r(`A(6,2,2)
B(3,8,3)
C(1,1,10)->*
p=plane A,B,C
O(0,0,6)->*
