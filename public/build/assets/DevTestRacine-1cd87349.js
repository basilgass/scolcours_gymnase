import{e as o}from"./pimath-7d48ec27.js";import{d as _,b as h,c as x,j as q,aJ as w,Y as y,Z as v,y as b,b3 as S,F as j}from"./@vue-d768c18d.js";import"./@svgdotjs-404fd87d.js";const B={class:"w-full",rows:"20"},G=_({__name:"DevTestRacine",setup(F){let $=h([]),d=h([]);x(()=>`\\begin{aligned} ${$.value.map((i,t)=>`${i}=${d.value[t]}`).join("\\\\")} \\end{aligned}`);let c=h([]),g=`\\documentclass[12pt]{article}
...
\\vfill
`};return q(()=>{p()}),(i,t)=>(w(),y(j,null,[v("button",{class:"btn bg-white",onClick:t[0]||(t[0]=(...r)=>b(p)&&b(p)(...r))},"Générer"),v("textarea",B,S(b(c).join(`
