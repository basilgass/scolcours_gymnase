import{D as e,U as t,ht as n,k as r,w as i,x as a}from"./@inertiajs-DtbEXzlC.js";import{t as o}from"./FormInput-y57CVEpT.js";import{t as s}from"./FormCodearea-l78_hP3v.js";import{t as c}from"./PiThreeParser-X-2ujLBQ.js";var l={ref:`root`},u={class:`grid grid-cols-1 md:grid-cols-2 gap-3`},d={class:`flex flex-col gap-2`},f=r({__name:`DevThreeComponent`,setup(r){let f=n(`grid,axis`),p=n(`A(6,2,2)
B(3,8,3)
C(1,1,10)->*
p=plane A,B,C
O(0,0,6)->*
