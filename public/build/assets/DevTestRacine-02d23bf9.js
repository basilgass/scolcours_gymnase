import{e as o}from"./pimath-7d48ec27.js";import{d as _,r as h,a as x,o as q,aF as w,J as y,L as v,u as b,b1 as S,F}from"./@vue-d8807e25.js";import"./@svgdotjs-404fd87d.js";const j={class:"w-full",rows:"20"},G=_({__name:"DevTestRacine",setup(B){let $=h([]),d=h([]);x(()=>`\\begin{aligned} ${$.value.map((i,t)=>`${i}=${d.value[t]}`).join("\\\\")} \\end{aligned}`);let c=h([]),g=`\\documentclass[12pt]{article}
