import{D as e,H as t,b as n,k as r,mt as i,nt as a,w as o,xt as s}from"./@inertiajs-DPgfgE8-.js";import{t as c}from"./PiDrawParser-R_ed-sOc.js";import{t as l}from"./Card-qf2bAOir.js";import{t as u}from"./useToolsStorage-D02c7LyO.js";import{t as d}from"./ToolForm-BPc7tpFo.js";var f={class:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3`},p=r({__name:`graphe`,setup(r){let{restoreTool:p}=u(),m=p([{label:`paramètres`,type:`codearea`,attributes:{language:`pidraw-params`,rows:1},value:i(`axis,grid,x=-10:10,y=-10:10`),fromUrl:`params`},{label:`code`,type:`codearea`,attributes:{language:`pidraw`,rows:10},value:i(`O(0,0)
A(5,1)
B(3,8)->drag=grid
d=OA.
e=OB.
