import{A as e,O as t,Q as n,S as r,T as i,U as a,ht as o,rt as s,x as c}from"./@inertiajs-C0oRnCTy.js";import{t as l}from"./PiDrawParser-B4gCNu18.js";import{t as u}from"./Card-y55CIRLv.js";import{t as d}from"./FormSwitch-BQce-y91.js";var f={class:`max-w-2xl mx-auto`},p={class:`flex justify-between mb-3`},m=`axis,x=-13:13,y=-18:18,ppu=20`,h=e({__name:`cercle-trigonometrique`,setup(e){let h=o(!0),g=o(!0),_=c(()=>`@begin:static
A(0,0)
c=circ A,10
P0(10,0)
...
T=inter p,t
t1=P0T.->gold,w=5
a=arc P0,A,P,2->tex=\\theta`:``)),v=n(`svgContainer`);return(e,n)=>(a(),i(`article`,f,[r(`div`,p,[t(d,{modelValue:h.value,"onUpdate:modelValue":n[0]||=e=>h.value=e,label:`afficher l'interactivité`,sm:``},null,8,[`modelValue`]),t(d,{modelValue:g.value,"onUpdate:modelValue":n[1]||=e=>g.value=e,label:`angles positifs,angles entre \\(-\\pi\\) et \\(\\pi\\)`,sm:``},null,8,[`modelValue`])]),t(u,null,{default:s(()=>[t(l,{ref_key:`svgContainer`,ref:v,draw:{code:_.value,parameters:m}},null,8,[`draw`])]),_:1})]))}});export{h as default};