...
P9(8.67,-5)->tex=${isPositive.value ? "\\frac{11\\pi}{6}" : "-\\frac{\\pi}{6}"}/tl/-0.1;0,fill=black,o=4
P10(7.07,-7.07)->tex=${isPositive.value ? "\\frac{7\\pi}{4}" : "-\\frac{\\pi}{4}"}/br/0.5;0,fill=black,o=4
P311(5,-8.67)->tex=${isPositive.value ? "\\frac{5\\pi}{3}" : "-\\frac{\\pi}{3}"}/bc/0.5;-0.5,fill=black,o=4
P12(0,-10)->tex=${isPositive.value ? "\\frac{3\\pi}{2}" : "-\\frac{\\pi}{2}"}/bl/-0.5;-0.3,fill=black,o=4
P13(-8.67,-5)->tex=${isPositive.value ? "\\frac{7\\pi}{6}" : "-\\frac{5\\pi}{6}"}/ml/-0.5;0,fill=black,o=4
P14(-7.07,-7.07)->tex=${isPositive.value ? "\\frac{5\\pi}{4}" : "-\\frac{3\\pi}{4}"}/bl/-0.5;0,fill=black,o=4
P15(-5,-8.67)->tex=${isPositive.value ? "\\frac{4\\pi}{3}" : "-\\frac{2\\pi}{3}"}/bc/-0.5;-0.5,fill=black,o=4
