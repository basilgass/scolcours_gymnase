...
<template>
	<form-field>
		...
		<div class="grid grid-cols-1 gap-3 mt-5">
			...
			<!-- image illustration -->
			<div v-if="modelValue.type === 'image'" class="col-span-2 mb-5">
			...
			>
				<div class="mb-3">
					<div
						class="font-code text-xs grid grid-cols-3 gap-3 gap-y-0 items-end"
					>
						<form-switch
			...
			<div
				v-else
				class="col-span-2 border-dashed border-gray-200 border-2 rounded h-full w-full grid grid-cols-1 items-center"
			>
