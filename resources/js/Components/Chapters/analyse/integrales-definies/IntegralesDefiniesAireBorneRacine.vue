			...
			<div>
				...
				<ol class="list-decimal list-inside space-y-4">
					...
					<li>
						...
						\[\mathcal{A}_1 = \int_{a}^{c}\ g(x) \text{d}x \qquad \qquad \mathcal{A}_2 = \int_{b}^{c}\
						f(x) \text{d}x\]
					</li>
					<li>
			...
			<div class="col-span-2">
				...
				<ol class="list-decimal list-inside space-y-4">
					<li v-show="solutions>0">
						\(\sqrt{8x+17} = 0\implies 8x+17=0 \implies x = -\dfrac{17}{8}\)
					</li>
...
`"
					...
					<li v-show="solutions>3">
						...
						<div class="space-y-5 pl-8">
							<p>
								\(\displaystyle \mathcal{A}_1 = \int_{-17/8}^{4} \sqrt{8x+17} \text{d}x =
								\frac{2}{24}\sqrt{8x+17}^3 \Big\vert_{-17/8}^{4} \approx 28.58 \)
							</p>
							<p>
								\(
								\displaystyle \mathcal{A}_2 = \int_{1/2}^{4} 2x-1 \text{d}x =
								x^2-x\Big\vert_{1/2}^{4} = 12.25
								\)
							</p>
						</div>
					</li>
...
function loadGraphBetween () {
	...
	graphBetween.axis()
	graphBetween.plot('2*x-1')
	graphBetween.plot('sqrt(8*x+17)', {
		domain: {
			min: -17 / 8,
			max: 20
		},
