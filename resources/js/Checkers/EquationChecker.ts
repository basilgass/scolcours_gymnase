...
export class EquationChecker extends CheckerBase {
    ...
    constructor(config: string[] | string) {
        ...
        this.isReduced = (this.config.includes("r") || this.config.includes("reduced") || this.config.includes("re"))
        this.isCanonical = (this.config.includes("c") || this.config.includes("canonical") || this.config.includes("ca"))
        this.isSommet = (this.config.includes("s") || this.config.includes("sommet"))
        this.isCentreRayon = (this.config.includes("cercle")) || (this.config.includes("circle"))
    }
    ...
    check(expected: string, given: string): { result: boolean; message: string } {
		...
		if(this.isSommet){
			...
			let polynomY = left==='y'?left:right,
