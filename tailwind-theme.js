...
export default {
	...
	global: {
		...
		input: 'appearance-none bg-transparent focus:outline-none focus:ring-0 focus:shadow-none transition',
		label: 'block font-bold text-xs',
	...
	'family:text': {
		inner: 'flex items-center border border-gray-200 focus-within:border-blue-500 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
