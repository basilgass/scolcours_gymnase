 ...
 */
    ...
    namespace Illuminate\Support\Facades {
		...
		use Illuminate\Support\DateFactory;use Illuminate\Support\LazyCollection;use Illuminate\Support\ServiceProvider;use Illuminate\Support\Stringable;use Illuminate\Support\Testing\Fakes\BusFake;use Illuminate\Support\Testing\Fakes\EventFake;use Illuminate\Support\Testing\Fakes\MailFake;use Illuminate\Support\Testing\Fakes\NotificationFake;use Illuminate\Support\Testing\Fakes\QueueFake;use Illuminate\Support\Timebox;use Illuminate\Translation\MessageSelector;use Illuminate\Validation\PresenceVerifierInterface;
...
')
     ...
     */
         ...
         * @static
         */
        public static function compileAmount($compileAmount)
        {
                        /** @var LaraTeX $instance */
                        return $instance->compileAmount($compileAmount);
        }
                    /**
...
namespace  {
	...
	use Ismaelw\LaraTeX\LaraTeXFacade;
	...
	class App extends \Illuminate\Support\Facades\App {}
            ...
            class LaraTeX extends LaraTeXFacade {}
